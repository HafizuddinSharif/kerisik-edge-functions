-- Migration: 20260227000000_create_kerisik_sync_schema
-- Description: Kerisik Cloud Sync Schema (offline-first backup/sync tables + RLS).
-- Source: supabase/schemas/kerisik_sync.sql
