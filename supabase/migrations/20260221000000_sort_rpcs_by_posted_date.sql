-- Migration: Sort get_collection_recipes and get_published_recipes by browsable_recipes.posted_date.
-- Backward compatible: same signature and return shape; only sort order changes.

-- get_collection_recipes: sort by posted_date (newest first; nulls last)
...
-- get_published_recipes: sort by posted_date (newest first; nulls last)
